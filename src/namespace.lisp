...
(macrolet ((e () '(error "Internal error - not all args were provided.")))
  (defstruct (namespace (:constructor %make-namespace))
    ...
    (documentation             (e) :type (or null string) :read-only t)))
...
;; * Documentation of type T with namespace objects is STILL available
;;
...
(defvar *namespaces*
  (make-namespace 'namespace :value-type 'namespace))
