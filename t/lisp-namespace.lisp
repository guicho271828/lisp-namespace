...
;; (test let
;;   (is (= 42 (namespace-let ((b 40))
;;               (+ b (let ((b 2))
;;                      b))))))

;; (test complicated
;;   ;; holy cow this test doesn't actually test anything
;;   (finishes
;;     `(namespace-let (((function x) (y) (1+ y))
;;                      ((macro x) (y) (1+ y))
;;                      ((macro y) (y) (1+ y))
;;                      ((label z) (y) (w y))
;;                      ((label w) (y) (z y))
...
;; (defpackage #:lisp-namespace/test2
;;   (:use #:cl
;;         #:lisp-namespace
;;         #:fiveam)
;;   (:import-from #:lisp-namespace/test
;;                 #:symbol-mytest
;;                 #:unbound-mytest
;;                 #:mytest
;;                 #:mytest-let))
...
;; (test export
;;   (let ((*package* (find-package '#:lisp-namespace/test2)))
;;     (eval
;;      (read-from-string
;;       (princ-to-string
;;        '(progn
