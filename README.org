...
It also defines a method for =cl:documentation= and extend =describe-object= with an =:after= method. For example, you will be able to =(setf (documentation 'mysymbol 'x) "description")= and you will see it pretty printed in =(describe 'mysymbol)=.
